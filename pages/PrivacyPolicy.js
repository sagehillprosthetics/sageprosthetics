    ...
    render() {
        return (
            <div style={{ margin: '0 15% 0 15%' }}>
                ...
                <div>
                    When filling out a contact form on our site, as appropriate, you may be asked to enter your name,
                    email address or other details to help you with your experience.
                </div>

                <h3 style={{ fontWeight: '500', marginTop: '1em' }}>When do we collect information?</h3>
                <div>
                    We collect information from you when you fill out a contact form or enter information on our site.
                </div>

                <h3 style={{ fontWeight: '500', marginTop: '1em' }}>How do we protect visitor information?</h3>
                <ul>
                    ...
                    <li style={styles.list}>We use regular Malware Scanning.</li>
                    <li style={styles.list}>
                        {
                ...
                <h3 style={{ fontWeight: '500', marginTop: '1em' }}>Do we use 'cookies'?</h3>
                <div>
                    ...
                    to recognize your browser and capture and remember certain information. They are also used to help
                ...
                <h3 style={{ fontWeight: '500', marginTop: '1em' }}>Third Party Disclosure</h3>
                <div>
                ...
                <h3 style={{ fontWeight: '500', marginTop: '1em' }}>Third party links</h3>
                <div>
                ...
                <div>
                    ...
                    <span style={{ fontWeight: '600' }}> We have implemented the following: </span>
                    <br />
                    <ul>
                        <li style={styles.list}>Demographics and Interests Reporting</li>
                    </ul>
                    ...
                    identifiers together. <br /> <br />
                    We use them to compile data regarding user interactions to improve our site.
                </div>

                <h3 style={{ fontWeight: '500', marginTop: '1em' }}>California Online Privacy Protection Act</h3>
                <div>
                    ...
                    <br /> <br />
                    <span style={{ fontWeight: '600' }}>According to CalOPPA we agree to the following:</span>
                    <br /> <br />
                    ...
                    the first significant page after entering our website. <br /> <br />
                    Our Privacy Policy link includes the word 'Privacy', and can be easily be found on the page
                    specified above. <br /> <br /> Users will be notified of any privacy policy changes:
                    <br />
                    <ul>
                ...
                <h3 style={{ fontWeight: '500', marginTop: '1em' }}>COPPA (Children Online Privacy Protection Act)</h3>
                <div>
                    ...
                    websites and online services must do to protect children's privacy and safety online. <br /> We do
                    not specifically market to children under 13.
                </div>

                <h3 style={{ fontWeight: '500', marginTop: '1em' }}>Fair Information Act</h3>
                <div>
                ...
                <h3 style={{ fontWeight: '500', marginTop: '1em' }}>CAN SPAM Act</h3>
                <div>
                    ...
                    <br /> <br />
                    <span style={{ fontWeight: '500' }}>We collect your email address in order to:</span>
                    <ul>
                        <li style={styles.list}>
                    ...
                    <ul>
                        <li style={styles.list}>NOT use false, or misleading subjects or email addresses.</li>
                        <li style={styles.list}>Identify the message as an advertisement in some reasonable way.</li>
                        <li style={styles.list}>Include the physical address of our business or site headquarters.</li>
                        <li style={styles.list}>
                            Monitor third party email marketing services for compliance, if one is used.
                        </li>
                        <li style={styles.list}>Honor opt-out/unsubscribe requests quickly.</li>
                        <li style={styles.list}>
                    ...
                    <ul>
                        <li style={styles.list}>Follow the instructions at the bottom of each email.</li>
                    </ul>
                    and we will promptly remove you from <span style={{ fontWeight: '500' }}>ALL</span> correspondence.
                </div>
            </div>
        );
    }
