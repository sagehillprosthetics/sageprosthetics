    ...
    render() {
        return (
            <div style={{ margin: '0 15% 0 15%' }}>
                ...
                <div>
                    When filling out a contact form on our site, as appropriate, you may be asked to
                ...
                <div>
                    We collect information from you when you fill out a contact form or enter
                ...
                <div>
                    ...
                    DoubleClick cookie) or other third-party identifiers together. <br /> <br />
                ...
                <div>
                    ...
                    or as a minimum on the first significant page after entering our website. <br />{' '}
                    <br />
                    Our Privacy Policy link includes the word 'Privacy', and can be easily be found
                    on the page specified above. <br /> <br /> Users will be notified of any privacy
                    policy changes:
                    <br />
                    <ul>
                ...
                <div>
                    ...
                    must do to protect children's privacy and safety online. <br /> We do not
                ...
                <div>
                    ...
                    <span style={{ fontWeight: '500' }}>ALL</span> correspondence.
                </div>
            </div>
        );
    }
