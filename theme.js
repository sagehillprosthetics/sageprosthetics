...
export const SHARPNESSES = ['rounded', 'soft', 'medium', 'hard'];
...
export const MOODS = ['default', 'pastel', 'soft', 'light', 'hard', 'pale'];

export const SCHEMES = ['monochromatic', 'contrast', 'triade', 'tetrade', 'analogic'];
